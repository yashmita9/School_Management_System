...
import com.erp.school.entityenum.BoardType;
...
public class SchoolRequestDTO {
	...
	@Size(min = 3, max = 100, message = "School name must be between 3 to 100 characters")
	@Pattern(regexp = "^[a-zA-Z ]+$", message = "School name must contain only letters and spaces")
	private String schoolName;

	@Size(max = 20, message = "School code must be less than 20 characters")
	private String schoolCode;

	@NotNull(message = "Board is required")
	private BoardType board;

	@Size(max = 50, message = "Affiliation number must be less than 50 characters")
