...
public interface StudentEnrollmentRepository extends BaseRepository<StudentEnrollmentEntity, Long> {
	...
	List<StudentEnrollmentEntity> findByClassEntityIdAndSectionEntityId(Long classId, Long sectionId);

	// Academic Year + Class wise students
	List<StudentEnrollmentEntity> findByAcademicYearIdAndClassEntityId(Long academicYearId, Long classId);

	// Roll number in same session/class
	Optional<StudentEnrollmentEntity> findByAcademicYearIdAndClassEntityIdAndRollNo(Long academicYearId, Long classId,
			String rollNo);
	...
	List<StudentEnrollmentEntity> findByClassEntityIdAndSectionEntityIdAndAcademicYearIdAndIsCurrentTrue(Long classId,
